...
import dev.batch.repository.bm.PgConnectionCleanupBmRepository;
 ...
 */
@Component
public class PgConnectionCleanupBmBatch {

    private static final String PROJECT_NAME = PgConnectionCleanupBmBatch.class.getProtectionDomain()
            .getCodeSource().getLocation().getPath();

    private static final String CLASS_NAME = PgConnectionCleanupBmBatch.class.getName();
    ...
    @Autowired
    private PgConnectionCleanupBmRepository cleanupRepository;
