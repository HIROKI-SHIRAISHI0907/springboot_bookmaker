...
CREATE TABLE initial_reading_csv_master (
  id            INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  master_name   VARCHAR(255) NOT NULL,
  country       VARCHAR(100) NOT NULL,
  league        VARCHAR(100) NOT NULL,
  initial_flg   CHAR(1) NOT NULL,
  register_id   VARCHAR(50) NOT NULL,
  register_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  update_id     VARCHAR(50) NOT NULL,
  update_time   TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,

  CONSTRAINT uq_initial_reading_csv_master_country_league
    UNIQUE (country, league)
);
...
CREATE TABLE IF NOT EXISTS team_color_master (
  ...
  country         VARCHAR(255) NOT NULL,
  league          VARCHAR(255) NOT NULL,
  sub_league      VARCHAR(255) NOT NULL,
  team            VARCHAR(255) NOT NULL,
  team_color_hex  VARCHAR(7),
  team_color_sub_hex  VARCHAR(7),
  register_id     VARCHAR(100),
  register_time   TIMESTAMP WITH TIME ZONE,
  update_id       VARCHAR(100),
  update_time     TIMESTAMP WITH TIME ZONE
...
-- -------------------------
CREATE TABLE IF NOT EXISTS stat_size_finalize_master (
  id            INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  option_num    CHAR(1) NOT NULL,
