 ...
 */
@Component
public class BmM019BmM020MatchClassificationResultBean {

	/** プロジェクト名 */
	private static final String PROJECT_NAME = BmM019BmM020MatchClassificationResultBean.class.getProtectionDomain()
			.getCodeSource().getLocation().getPath();

	/** クラス名 */
	private static final String CLASS_NAME = BmM019BmM020MatchClassificationResultBean.class.getSimpleName();
