...
import dev.application.domain.repository.bm.MatchTeamAttackStatsRepository;
import dev.common.constant.MessageCdConst;
import dev.common.exception.wrap.RootCauseWrapper;
import dev.common.logger.ManageLoggerComponent;

/**
 * BM_M035 MatchTeamAttackStats 登録Writer
 */
@Component
public class MatchTeamAttackStatsWriter {

	private static final String PROJECT_NAME = MatchTeamAttackStatsWriter.class.getProtectionDomain()
			.getCodeSource().getLocation().getPath();

	private static final String CLASS_NAME = MatchTeamAttackStatsWriter.class.getName();

	private static final String BM_NUMBER = "BM_M035";

	private static final String MATCH_TEAM_ATTACK_STATS = "matchTeamAttackStats";

	@Autowired
	private MatchTeamAttackStatsRepository matchTeamAttackStatsRepository;
	...
	public void insert(MatchTeamAttackStatsEntity entity) {
		...
		String fillChar = setLoggerFillChar(
				...
				MATCH_TEAM_ATTACK_STATS);

		int result = this.matchTeamAttackStatsRepository.insert(entity);
