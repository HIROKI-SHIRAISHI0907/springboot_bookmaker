...
public interface CountryLeagueSeasonMasterRepository {
	...
	@Insert({
			...
			"id, country, league, start_season_date, end_season_date, upd_stamp,",
			"register_id, register_time, update_id, update_time) VALUES (",
			"#{id}, #{country}, #{league}, #{startSeasonDate}, #{endSeasonDate}, #{updStamp}",
	...
	@Select({
			"SELECT id, country, league, start_season_date, end_season_date, upd_stamp FROM country_league_season_master ",
