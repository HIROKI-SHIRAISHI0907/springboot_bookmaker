...
@Mapper
public interface StatEncryptionRepository {
	 ...
	 @Insert({
	    ...
	    @Update({
	        ...
	        "away_in_goal_exp_info = #{awayInGoalExpInfo},",
	        ...
	        "home_long_pass_count_info_on_success_count = #{homeLongPassCountInfoOnSuccessCount},",
	        "away_long_pass_count_info_on_success_count = #{awayLongPassCountInfoOnSuccessCount},",
