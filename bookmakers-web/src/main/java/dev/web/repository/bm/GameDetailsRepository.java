...
public class GameDetailsRepository {
	...
	private static final String BASE_SELECT = """
			SELECT
			  ...
			  NULLIF(TRIM(d.home_cross_count), '')::int AS home_cross_count,
			  NULLIF(TRIM(d.away_cross_count), '')::int AS away_cross_count,
			  NULLIF(TRIM(d.home_tackle_count), '')::int AS home_tackle_count,
			  NULLIF(TRIM(d.away_tackle_count), '')::int AS away_tackle_count,
			  NULLIF(TRIM(d.home_clear_count), '')::int AS home_clear_count,
			  NULLIF(TRIM(d.away_clear_count), '')::int AS away_clear_count,
			  NULLIF(TRIM(d.home_duel_count), '')::int AS home_duel_count,
			  NULLIF(TRIM(d.away_duel_count), '')::int AS away_duel_count,
			  NULLIF(TRIM(d.home_intercept_count), '')::int AS home_intercept_count,
			  NULLIF(TRIM(d.away_intercept_count), '')::int AS away_intercept_count,
