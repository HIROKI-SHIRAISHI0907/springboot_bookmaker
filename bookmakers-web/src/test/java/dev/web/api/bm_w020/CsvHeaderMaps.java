...
public class CsvHeaderMaps {
	...
	/** 起源データ（日本語ヘッダ）→ CountryLeagueEntity */
	public static final Map<String, String> COUNTRY_LEAGUE_ORIGIN = new LinkedHashMap<>() {{
		put("id", "id");
		put("country", "country");
		put("league", "league");
		put("sub_league", "subLeague");
		put("team", "team");
		put("link", "link");
		put("del_flg", "delFlg");
		put("register_id", "registerId");
		put("register_time", "registerTime");
		put("update_id", "updateId");
		put("update_time", "updateTime");
	}};

	/** 起源データ（日本語ヘッダ）→ AllLeagueEntity */
	public static final Map<String, String> ALL_LEAGUE_ORIGIN = new LinkedHashMap<>() {{
		put("id", "id");
		put("country", "country");
		put("league", "league");
		put("sub_league", "subLeague");
		put("logic_flg", "logicFlg");
		put("disp_flg", "dispFlg");
		put("register_id", "registerId");
		put("register_time", "registerTime");
		put("update_id", "updateId");
		put("update_time", "updateTime");
	...
	/** 起源データ（日本語ヘッダ）→ TeamColorEntity */
	public static final Map<String, String> TEAM_COLOR_ORIGIN = new LinkedHashMap<>() {{
		put("id", "id");
		put("country", "country");
		put("league", "league");
		put("sub_league", "subLeague");
		put("team", "team");
		put("team_color_main_hex", "teamColorMainHex");
		put("team_color_sub_hex", "teamColorSubHex");
		put("del_flg", "delFlg");
		put("register_id", "registerId");
		put("register_time", "registerTime");
		put("update_id", "updateId");
